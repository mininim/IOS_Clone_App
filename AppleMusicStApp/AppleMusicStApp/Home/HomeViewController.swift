    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        case UICollectionView.elementKindSectionHeader: 
            ...
            header.tapHandler = {item -> Void in
                // Player를 띄운다
                let playerStroyboard = UIStoryboard.init(name: "Player", bundle: nil)
                
                guard let playerVC = playerStroyboard.instantiateViewController(withIdentifier: "PlayerViewController") as? PlayerViewController else {return}
...
extension HomeViewController: UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        //Player 스토리 보드를 저장 --> 그 스토리 보드 안에 여러가지 뷰컨트롤러 가 있는데 그 안에 특정 뷰컨트롤러를 가져오기
        let playerStroyboard = UIStoryboard.init(name: "Player", bundle: nil)
